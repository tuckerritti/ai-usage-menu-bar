...
swiftc -swift-version 6 -parse-as-library AIUsage/StartupSettings.swift Tests/StartupSettingsChecks.swift -o "$check_dir/startup-settings-checks"
"$check_dir/startup-settings-checks"
